...
CREATE TABLE `technician_specializations` (
  ...
  CONSTRAINT `technician_specializations_ibfk_1` FOREIGN KEY (`technician_id`) REFERENCES `technicians` (`technician_id`),
  CONSTRAINT `technician_specializations_ibfk_2` FOREIGN KEY (`appliance_id`) REFERENCES `appliance_types` (`appliance_id`)
